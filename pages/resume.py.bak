...
## Projects
''')
txt('**Personal expense tracker**, [streamlit, demodb , plotly] (https://naashonomics-streamlit-cloud-streamlit-app-tgu0tp.streamlitapp.com/expense_tracker)', 'August 2022')
