...
## Projects
''')
txt('**Personal expense tracker**, [Demo](https://naashonomics-streamlit-cloud-streamlit-app-tgu0tp.streamlitapp.com/expense_tracker)', '[Streamlit,Demo DB,Plotly]' ,'August 2022')
